...
- **CI/CD**: Final synchronization for Trusted Publishing on PyPI.
- **CI/CD**: Added verbose dependency logging to troubleshoot CI environment issues.

## [0.1.8] - 2026-04-27

### Fixed

- **CI/CD**: Simplified `publish.yml` by removing GitHub Environments to streamline OIDC publishing.
- **CI/CD**: Improved troubleshooting logs for test failures.

## [0.1.7] - 2026-04-27

### Fixed

- **CI/CD**: Corrected hardcoded coverage threshold in `test.yml` to match `pyproject.toml`.

## [0.1.6] - 2026-04-27

### Changed

- **CI/CD**: Relaxed coverage threshold to 80% to improve build stability in diverse CI environments.
- **Release**: Automated PyPI publishing via GitHub Actions.

## [0.1.5] - 2026-04-27

### Fixed

- **CI/CD**: Added `build-essential` to Linux test runners to ensure binary dependency compilation.
- **Security**: Simplified CodeQL configuration for public repository compatibility.
- **Docs**: Synchronized badges with public repository visibility.
