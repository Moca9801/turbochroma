...
- `pytest --cov=turbochroma --cov-report=term-missing --cov-fail-under=80` (line coverage must stay ≥ 80%)
...
- CI must pass on `main` (Python 3.10–3.12 on Ubuntu, plus macOS on 3.11; lint on 3.11).
